...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="{{ URL::asset('/') }}/Content/d3a8c20cc5254e4ebbe55496531d1ddc//AdminLTE-2.3.11/plugins/iCheck/square/blue.css">
...
<div class="login-box">
  <div class="login-logo">@section('dzLogoLogin')
    @show</div>
  <!-- /.login-logo -->
  <div class="login-box-body">@section('DZLOGEO')
    @show</div>
  <!-- /.login-box-body -->
</div>
<!-- /.login-box -->
...
<!-- iCheck -->
<script src="{{ URL::asset('/') }}/Content/d3a8c20cc5254e4ebbe55496531d1ddc//AdminLTE-2.3.11/plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
