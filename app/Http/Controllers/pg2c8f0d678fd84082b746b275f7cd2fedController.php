...
/**
 * productosForm - Formulario de Productos.
 */
class pg2c8f0d678fd84082b746b275f7cd2fedController extends Controller
{
    /**
    ...
    public function post(Request $request)
    {
        ...
        if (null != $request->input('ctl4abe39ab8dcd40df8f7b8ba7891aee90_63680ff814c647c8a7a32ec4bb98c96f') && null != $request->input('hid63680ff814c647c8a7a32ec4bb98c96f') && '63680ff814c647c8a7a32ec4bb98c96f' == $request->input('hid63680ff814c647c8a7a32ec4bb98c96f')) {
            $key = 0;
            $isNew = false;
            ...
            $tb = \App\tbf76586750f8e4c97a3deffd24fadad6f::where('PK_PRODUCTO', $key)->first();
            if (null == $tb) {
                $tbCheck = \App\tbf76586750f8e4c97a3deffd24fadad6f::where([['FL_NOMBRE', '=', $request->input('ctl6de877eb22f748848892b6b422376982_63680ff814c647c8a7a32ec4bb98c96f')]])->first();
                if (null != $tbCheck) {
                    return \Response::json('AlreadyExists');
                }

                $isNew = true;
                $tb = new \App\tbf76586750f8e4c97a3deffd24fadad6f();
            }

            if (null != $request->input('ctl6de877eb22f748848892b6b422376982_63680ff814c647c8a7a32ec4bb98c96f')) {
                $tb->FL_NOMBRE = $request->input('ctl6de877eb22f748848892b6b422376982_63680ff814c647c8a7a32ec4bb98c96f'); //FL_NOMBRE
            } elseif (null == $request->input('ctl6de877eb22f748848892b6b422376982_63680ff814c647c8a7a32ec4bb98c96f')) {
                $tb->FL_NOMBRE = null;
            }

            if (null != $request->input('ctl6989c25f7ee24c3997710d6129ce7a81_63680ff814c647c8a7a32ec4bb98c96f')) {
                $tb->FK_CATEGORIA = $request->input('ctl6989c25f7ee24c3997710d6129ce7a81_63680ff814c647c8a7a32ec4bb98c96f'); //FK_CATEGORIA
            } elseif (null == $request->input('ctl6989c25f7ee24c3997710d6129ce7a81_63680ff814c647c8a7a32ec4bb98c96f')) {
                $tb->FK_CATEGORIA = null;
            }
    ...
    public function index(Request $request)
    {
        ...
        $par6185a7056560433494dba94e9ae59107530ea3da651a4835a2771fef48327834 = 0;

        if (null == $par6185a7056560433494dba94e9ae59107530ea3da651a4835a2771fef48327834) {
            $par6185a7056560433494dba94e9ae59107530ea3da651a4835a2771fef48327834 = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb860530ea3da651a4835a2771fef48327834 = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb860530ea3da651a4835a2771fef48327834) {
            $par0a0ce2af85ab462a808e0270326fb860530ea3da651a4835a2771fef48327834 = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce530ea3da651a4835a2771fef48327834 = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce530ea3da651a4835a2771fef48327834) {
            $par5551ae677d6b488ebd38625d0f5d9fce530ea3da651a4835a2771fef48327834 = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce530ea3da651a4835a2771fef48327834) {
            $par5551ae677d6b488ebd38625d0f5d9fce530ea3da651a4835a2771fef48327834 = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a5530ea3da651a4835a2771fef48327834 = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a5530ea3da651a4835a2771fef48327834) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5530ea3da651a4835a2771fef48327834 = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a5530ea3da651a4835a2771fef48327834) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a5530ea3da651a4835a2771fef48327834 = '';
        }

        $v530ea3da651a4835a2771fef48327834 = \App\rep0a14ea93830f4813be11c92f6fdf225f::mtcff51f8ff2be4b21bac46a431d7717b5($par6185a7056560433494dba94e9ae59107530ea3da651a4835a2771fef48327834, $par0a0ce2af85ab462a808e0270326fb860530ea3da651a4835a2771fef48327834, $par5551ae677d6b488ebd38625d0f5d9fce530ea3da651a4835a2771fef48327834, $par8fce8a73ac264e4a8f3b56d8b991b8a5530ea3da651a4835a2771fef48327834);

        $v530ea3da651a4835a2771fef48327834Ajax = \URL::to('/').'/api/cff51f8ff2be4b21bac46a431d7717b5/{page}/{pagesize}/{orderColumn}/{orderType}';

        // Recuperar Productor - Recuperar Productor

        $par0f6b13f543a14f43934d960cedb38ddf = $request->input('u');

        if (null == $par0f6b13f543a14f43934d960cedb38ddf) {
            $par0f6b13f543a14f43934d960cedb38ddf = '0';
        }

        $par6185a7056560433494dba94e9ae591070be723c1f8474c17aef34b318f25904a = 0;

        if (null == $par6185a7056560433494dba94e9ae591070be723c1f8474c17aef34b318f25904a) {
            $par6185a7056560433494dba94e9ae591070be723c1f8474c17aef34b318f25904a = '0';
        }

        $par0a0ce2af85ab462a808e0270326fb8600be723c1f8474c17aef34b318f25904a = 0;

        if (null == $par0a0ce2af85ab462a808e0270326fb8600be723c1f8474c17aef34b318f25904a) {
            $par0a0ce2af85ab462a808e0270326fb8600be723c1f8474c17aef34b318f25904a = '0';
        }

        $par5551ae677d6b488ebd38625d0f5d9fce0be723c1f8474c17aef34b318f25904a = '';

        if ('-' == $par5551ae677d6b488ebd38625d0f5d9fce0be723c1f8474c17aef34b318f25904a) {
            $par5551ae677d6b488ebd38625d0f5d9fce0be723c1f8474c17aef34b318f25904a = null;
        }

        if (null == $par5551ae677d6b488ebd38625d0f5d9fce0be723c1f8474c17aef34b318f25904a) {
            $par5551ae677d6b488ebd38625d0f5d9fce0be723c1f8474c17aef34b318f25904a = '';
        }

        $par8fce8a73ac264e4a8f3b56d8b991b8a50be723c1f8474c17aef34b318f25904a = '';

        if ('-' == $par8fce8a73ac264e4a8f3b56d8b991b8a50be723c1f8474c17aef34b318f25904a) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a50be723c1f8474c17aef34b318f25904a = null;
        }

        if (null == $par8fce8a73ac264e4a8f3b56d8b991b8a50be723c1f8474c17aef34b318f25904a) {
            $par8fce8a73ac264e4a8f3b56d8b991b8a50be723c1f8474c17aef34b318f25904a = '';
        }

        $v0be723c1f8474c17aef34b318f25904a = \App\rep0a14ea93830f4813be11c92f6fdf225f::mt3d113fe1c4664c5faf23248cb00d410f($par0f6b13f543a14f43934d960cedb38ddf, $par6185a7056560433494dba94e9ae591070be723c1f8474c17aef34b318f25904a, $par0a0ce2af85ab462a808e0270326fb8600be723c1f8474c17aef34b318f25904a, $par5551ae677d6b488ebd38625d0f5d9fce0be723c1f8474c17aef34b318f25904a, $par8fce8a73ac264e4a8f3b56d8b991b8a50be723c1f8474c17aef34b318f25904a);

        $v0be723c1f8474c17aef34b318f25904aAjax = \URL::to('/').'/api/3d113fe1c4664c5faf23248cb00d410f/'.(null == $par0f6b13f543a14f43934d960cedb38ddf ? '-' : ('' == $par0f6b13f543a14f43934d960cedb38ddf ? '-' : $par0f6b13f543a14f43934d960cedb38ddf)).'/{page}/{pagesize}/{orderColumn}/{orderType}';
        ...
        $arrWiths['v530ea3da651a4835a2771fef48327834'] = isset($v530ea3da651a4835a2771fef48327834) ? $v530ea3da651a4835a2771fef48327834 : '';
        $arrWiths['v530ea3da651a4835a2771fef48327834Ajax'] = isset($v530ea3da651a4835a2771fef48327834Ajax) ? $v530ea3da651a4835a2771fef48327834Ajax : '';
        $arrWiths['v0be723c1f8474c17aef34b318f25904a'] = isset($v0be723c1f8474c17aef34b318f25904a) ? $v0be723c1f8474c17aef34b318f25904a : '';
        $arrWiths['v0be723c1f8474c17aef34b318f25904aAjax'] = isset($v0be723c1f8474c17aef34b318f25904aAjax) ? $v0be723c1f8474c17aef34b318f25904aAjax : '';
        ...
        $response = new \Illuminate\Http\Response(view('2c8f0d678fd84082b746b275f7cd2fed.Index', $arrWiths)->with('title', $arrWiths['title'])->with('vSessionTimeout', \Config::get('session.lifetime') * 60));
